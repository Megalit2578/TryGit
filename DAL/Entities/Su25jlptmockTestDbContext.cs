...
public partial class Su25jlptmockTestDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CandidateId).HasName("PK__Candidat__DF539BFCEEA99DAE");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__JLPTAcco__349DA5866ABCA613");

            entity.ToTable("JLPTAccount");

            entity.HasIndex(e => e.Email, "UQ__JLPTAcco__A9D105342CA139C7").IsUnique();
        ...
        {
            entity.HasKey(e => e.TestId).HasName("PK__MockTest__8CC33100AEA7725C");
